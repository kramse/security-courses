...
\lhead{\fancyplain{}{\color{titlecolor}\bfseries\LARGE Exercises: \subject}}
...
I will reference the CIS controls. We don't need the full framework, but if you want to check it out after it is available at: \link{https://www.cisecurity.org/controls}

Ask me to upload CIS controls documents to Fronter, if I forgot
