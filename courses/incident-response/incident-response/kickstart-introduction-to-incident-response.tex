...
\link{https://github.com/kramse/security-courses/tree/master/courses/incident-response/incident-response}
\item[\faSquareO] Get the book \emph{Intelligence-Driven Incident Response} (IDIR)
 Scott Roberts. Rebekah Brown, ISBN: 9781491934944
\item[\faSquareO] Get the book \emph{Forensic Discovery} (FD), Dan Farmer and Wietse Venema! You can download \emph{for free}: \link{http://fish2.com/security/}
\item[\faSquareO] Get the document \emph{Computer Security Incident Handling Guide}, NIST SP 800-61 Rev. 2, August 2012
\link{https://doi.org/10.6028/NIST.SP.800-61r2}
\item[\faSquareO] Create a Debian Linux VM version 12 Bookworm -- it is enough if each group has one Debian VM
\end{list1}
