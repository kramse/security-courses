...
\link{https://github.com/kramse/security-courses/tree/master/courses/incident-response/intro-to-incident-response}
...
\item[\faSquareO] Get the book \emph{Forensic Discovery} (FD), Dan Farmer and Wietse Venema! Either on paper or PDF\\
You can download \emph{for free}: \link{http://fish2.com/security/}
\item[\faSquareO] Create a Debian Linux VM version 12 Bookworm
\end{list1}
