...
\mytitle{Networking and TCP/IP for Beginners}{exercises}
...
This material was originally prepared for use in a course \emph{Communication and Network Security } and was prepared by Henrik Kramselund  , \link{http://www.zencurity.com} .
It describes the networking setup and applications for trainings and workshops where hands-on exercises are needed.

Further a presentation is used which is available as PDF from kramse@Codeberg\\
...
The tool we need today is \link{https://codeberg.org/isginf/pcap-diff}
...
git clone https://codeberg.org/isginf/pcap-diff.git
cd pcap-diff/
...
\link{https://codeberg.org/kramse/frankenpacket}
...
Download the repository/clone it using git\\
\verb+$ git clone https://codeberg.org/kramse/frankenpacket.git+
...
\end{quote}
\link{https://codeberg.org/stamparm/maltrail}
...
\verb+https://codeberg.org/cowrie/cowrie+
