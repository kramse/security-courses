...
\begin{list2}
\item When working with firewalls some very important things to consider:
\item What are normal traffic levels?
\item How many source IPs going to how many destinations?
\item Resource usage cpu and memory on a normal day
\end{list2}
\end{list1}
...
\begin{list2}
\item Security Review: The Upper Layers
\end{list2}
\end{list1}
...
\hlkimage{10cm}{images/m0n0wall-1.pdf}
