...
\chapter{\faInfoCircle\ Investigate /etc 10 min}
...
\chapter{\faExclamationTriangle\ Use Ansible to install Elastic Stack}
...
\chapter{\faInfoCircle\ Try Hydra brute force 30min}
...
\chapter{\faInfoCircle\ VLANs, Routing and RPF - 2h}
