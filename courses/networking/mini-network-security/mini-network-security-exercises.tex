...
Det betyder at RFC-0791 altså er en standard og den erstatter
RFC-0760.
...
{\bfseries Formål:}\\
Prøve en værktøjskasse med netværksværktøjer.
...
formål. Nogle af de mest kendte indenfor sikkerhed er:
\begin{itemize}
\item BackTrack Linux - en større
...
Specielt hvis man ønsker at bruge trådløse værktøjer fra BackTrack
...
{\bfseries Hjælp:}\\
Prøv \verb+ab -n 100 http://www.pentest.dk/+
...
\chapter{Wardriving på Windows - inSSIDer}
