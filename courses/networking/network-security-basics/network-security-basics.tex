...
\item So we still have problems on all layers
\end{list1}

\slide{Solutions to TCP sequence problems}
...
\slide{Use the encryption protocols in networks}

\hlkimage{6cm}{800px-Diffie-Hellman_Key_Exchange.png}

Picture from \url{https://en.wikipedia.org/wiki/Diffie%E2%80%93Hellman_key_exchange}
...
\item Which is maintained and updated regularly
\item Using individual authentication is preferred\\
IEEE 802.1x Port Based Network Access Control
\item Create more VLANs with IEEE 802.1q and use both 1q and 1x on Ethernet!
\end{list1}
...
\begin{list1}
\item Today a firewall infrastructure must:
\begin{list2}
