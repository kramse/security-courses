...
Not very usable in the original form today, but similar ARP spoofing, VXLAN and MPLS instead
\item Routing Information Protocol Attacks\\
The Routing Information Protocol [15] (RIP) - RIP is dead, outdated -- luckily
\item BGPv4 used today, and continously have major issues, patches on patches and bad configurations -- very few secure it properly
\end{list2}
\vskip 1cm
\item Near to the LAN we have other Problems
\item Check low level attacks from \link{https://github.com/tomac/yersinia}
\end{list1}
