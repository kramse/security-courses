...
place during BornHack in the network warrior village, or similar events!
\end{list2}

\vskip 1cm

\centerline{Invite a few friends and work together!}
...
Erstatning for eet kodeord WEP -- WPA PSK Pre-shared key

\begin{list1}
\item Det anbefales at bruge:
%\begin{list2}
\item Kendte VPN teknologier eller WPA Enterprise
