...
Exam: 7/1 2021 \hskip 12cm Photo by Pawel Janiak on Unsplash
...
SIEM architectures frameworks \hskip 3cm acquire process Zeek
...
\slide{Book: Data-Driven Security: Analysis, Visualization and Dashboards}
...
\slide{Book: Crafting the InfoSec Playbook}
...
\hlkimage{5cm}{book-intelligence-driven-incident-response.jpg}
...
\slide{Book: Security Operations Center}

\hlkimage{5cm}{ book-security-operations-center-cisco.jpg}
...
\slidenext{Buy the books! Create your VM}
