...
29/10 , \sout{31/10} - moving! , 5/11 , 7/11 , 12/11 , 14/11, 19/11

Suggestion for replacement date 26/11

Exam: 2/12 2024 \hskip 12cm Photo by Pawel Janiak on Unsplash
...
{\bf Læringsmål}\\
{\bf Viden} -- Den studerende har viden om og forståelse for:
\begin{list2}
...
\link{https://github.com/kramse/kea-it-sikkerhed/tree/master/siem-og-loganalyse}
...
\hlkimage{14cm}{image/selks-16.png}
...
\hlkimage{14cm}{image/selks-17.png}
...
\item Go to GitHub, Find user Kramse, click through kramse-labs
\item Look into the instructions for the Virtual Machine -- Debian only
\item Easy install and running using Docker:\\
Use the repository kramse-labs from the Git exercise and install Docker, Run SELKS as described in the Kickstart 2 document
\item Advanced users, production setup:\\
Follow instructions for Ansible install, with newer version of Elasticsearch. There will probably be small issues, and it will take longer. It will mimic a production setup, so a nice proof-of-concept
\end{list2}
...
%\exercise{ex:elastic-password}
%\exercise{ex:kibana-enrollment}
