...
\vskip 1cm
\item Skim CIP 3 What Are the Threats? 14
...
\begin{list2}
\item Programming languages and frameworks Java, Python
\item Development environments -- choose your own IDE NetBeans / Eclipse / IntelliJ, Atom
\item Systems running Java Elastic stack elements Logstash, Elasticsearch
