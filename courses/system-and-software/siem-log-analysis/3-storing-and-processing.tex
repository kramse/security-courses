...
\slide{Today we need Elastic stack running!}

\hlkimage{14cm}{elastic-logstash-queue-publish.png}

Note: Kibana makes it easy to use sample data, feel free to experiment!

Elasticsearch and Kibana are \emph{services} which open a listening socket/port. zSo access ES via \link{https://127.0.0.1:9200} and Kibana via \link{https://127.0.0.1:5601} on your Debian using a browser or Postman
