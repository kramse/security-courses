...
This material is prepared for use in \emph{SIEM and Log Analysis course} and was prepared by
...
\chapter{\faInfoCircle\ Getting started with the Elastic Stack -- 60min}
...
\chapter{\faInfoCircle\ Configure Elasticsearch passwords -- 15 min}
...
\chapter{\faInfoCircle\ Configure Kibana -- 15 min}
...
\url{https://www.brimdata.io/download/} I choose the one for Ubuntu/Debian named:\\ \url{https://github.com/brimdata/zui/releases/download/v1.18.0/zui_1.18.0_amd64.deb}
...
{\bf Suggested method:}\\
Make sure Elasticsearch is running, with Kibana. You can browse indices through Kibana, which is great

Advanced users:\\
If you have the full Elasticsearch stack installed locally try running: \link{https://127.0.0.1:9200}
...
\link{https://www.elastic.co/guide/en/elasticsearch/reference/current/index-mgmt.html}
...
\chapter{\faInfoCircle\ Zeek Data in Elasticsearch -- 30min}
...
\link{https://www.elastic.co/guide/en/kibana/8.x/alerting-getting-started.html}
