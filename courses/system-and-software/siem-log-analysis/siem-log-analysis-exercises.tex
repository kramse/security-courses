...
{\bf Objective:}\\
Try the program Git locally your workstation
...
\chapter{Git and Github, clone XX - 30min}
...
{\bf Objective:}\\
Find out what IP reputation lists are with examples
...
Maltrail contains a lot of lists.
...
zkg install something

https://packages.zeek.org/
153 packages!

Look at example scripts like some from CVEs
