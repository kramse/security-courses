...
Henrik Kramselund, \url{xhek@ek.dk}.
...
{\bf The main site is: \link{https://codeberg/kramse/}} I try to gather all information there!\\
To get kickstarted in this course:

\begin{list2}
\item[\faSquareO] Make sure you can login to Fronter \link{https://ek.itslearning.com/}\\
Electronic version of this document will be uploaded here!
\item[\faSquareO] Lecture plan for this course will be in Fronter\\
Source is also in Git \link{https://codeberg.org/kramse/kea-it-sikkerhed/blob/master/softwaresikkerhed/lektionsplan.md}
\item[\faSquareO] Bookmark the main Github page: \link{https://codeberg.org/kramse/}\\
...
{\footnotesize\link{https://codeberg.org/kramse/security-courses/tree/master/courses/system-and-software/software-security-2026}}
\item[\faSquareO] We recommend to do exercises in teams of 2-3 persons
\item[\faSquareO] We will use virtualization, so check BIOS settings\\
-- make sure CPU settings have virtualisation turned ON
\item[\faSquareO] Select and install software
