...
\begin{list2}
\item \emph{Security Measures in OpenSSH} Damien Miller, Asiabsdcon 2007, slides
\item \emph{Deterministic Behaviours are your Attacker's Friend}, Theo de Raadt, OpenBSD  CUUG 2019, slides
\item \emph{Removing ROP Gadgets from OpenBSD}, Todd Mortimer, OpenBSD
\end{list2}


{\bf Note: A lot has been added to the room in itslearning!}
...
\vskip 1em
\item 12:45 - 13:45 -- What is software, presentation
\item 14:00 - 14:45 -- 45min Exercises and setup: Git, K8s, K3s
\item 14:45 - 15:00 -- 15min break
\item 15:00 - 15:45 -- 45min Teaching real life examples OpenBSD, OpenSSH, etc.
\item 15:45 - 16:00 -- 15min break
\item 16:00 - 16:45 -- 45min Exercises JuiceShop
...
\item \emph{IT Security Guidelines for Transport Layer Security (TLS)},\\ \verb+IT+Security+Guidelines+for+Transport+Layer+Security+v2.1.pdf+
\item \emph{24 Deadly Sins of Software Security Programming Flaws and How to Fix Them},\\
book-summary-24-deadly-sins.pdf, table of contents
\item \emph{The Tangled Web: A Guide to Securing Modern Web Applications}, chapter 3, \verb+tangledweb_ch3.pdf+
\item \emph{The Transport Layer Security (TLS) Protocol
Version 1.2}, RFC 5246, only Table of Contents, rfc5246.txt.pdf
\item \emph{OWASP Testing Guide v4}, \verb+OWASP_Testing_Guide_v4.pdf+
\end{list2}
