...
\item Exercises
\begin{list2}
\item Run small programs Python and Shell
\item See parts of Django tutorial
...
Plan for the day
\begin{list1}
\item 12:45 - 13:45 -- Teaching: Design vs Implementation
\item 13:45 - 14:00 -- 15min break
\item 14:00 - 14:45 -- 45min Exercises: Run small programs Python and Shell, See parts of Django tutorial
\item 14:45 - 15:00 -- 15min break
\item 15:00 - 15:45 -- 45min Teaching: buffer overflows
\item 15:45 - 16:00 -- 15min break
\item 16:00 - 16:45 -- 45min Exercises: buffer overflows, read, research, understand
\vskip 1em
...
Curriculum:
% Old book, to be removed, kept in case we need similar stuff later
%\begin{list1}
