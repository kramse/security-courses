...
\item Symmetric Cryptosystems / Public Key Cryptography
...
Plan for the day
\begin{list1}
\item 12:45 - 13:45 -- Teaching: Catch up, design, Deadly sins, buffer overflow repeat
\item 13:45 - 14:00 -- 15min break
\item 14:00 - 14:45 -- 45min Exercises: Ex 16: Real Vulnerabilities -- learn to read about vulns
\item 14:45 - 15:00 -- 15min break
\item 15:00 - 15:45 -- 45min Teaching: SDLC
\item 15:45 - 16:00 -- 15min break
\item 16:00 - 16:45 -- 45min Exercises: fun with a few active web scanners, OR revisit Trivy and \verb+kube-bench+
\vskip 1em
...
After today please read supporting litterature:
\begin{list2}
...
We talked about security design with Qmail and Postfix recently. 2019 was bad for Exim mailserver: CVE-2019-10149, CVE-2019-13917 and CVE-2019-15846
...
This Exim flaw is currently tracked under the CVE-2019-10149 identifier, but Qualys refers to it under the name of \textbf{"Return of the WIZard"} because the \textbf{vulnerability resembles the ancient WIZ and DEBUG vulnerabilities that impacted the Sendmail email server back in the 90s.}
\end{quote}
...
The flaw tracked as CVE-2019-15846 — initially reported by 'Zerons' on July 21 and analyzed by Qualys' research team — is \textbf{"exploitable by sending an SNI ending in a backslash-null sequence during the initial TLS handshake"} which leads to \textbf{RCE with root privileges on the mail server.}
\end{quote}
...
Old example, but includes both design mistakes and implementation mistakes
...
\item Vulnerabilities emerge during design and implementation -- before, during and after approach is needed
\end{list2}

\slide{Naming Variations}

\begin{list2}
\item Same concept, many names across vendors and standards
\item SSDL / SDL --- Secure (Software) Development Lifecycle
\item Microsoft SDL --- Security Development Lifecycle
...
Many names, goal is to make more secure software
...
\hlkimage{5cm}{hacklab-1.png}

I is always recommended to have a testing lab, where you can run \emph{dangerous
 stuff}
\begin{list2}
...
Note: the recent AI \emph{escapes} makes this even more relevant
