...
Henrik Kramselund Jereminsen, Zencurity Aps.
...
{\bf Suggested method:}\\
Follow instructions from \link{https://kubernetes.io/docs/tutorials/hello-minikube/}
...
{\bf Suggested method:}\\
Go to the article:\\
\link{https://www.nginx.com/blog/nginx-plus-ingress-controller-kubernetes-load-balancing/}
...
{\bf Suggested method:}\\
Go to the article:\\
\link{https://cloud.google.com/architecture/deploying-highly-available-postgresql-with-gke}
