...
23/4, 25/4, 30/4, 2/5, 7/5, 9/5, 14/5, 16/5, (21/5), (23/5), 28/5, 4/6, 6/6, 11/6, 13/6

Exam: tuesday 25/6 exam

{\bf Changes: the dates 21/5 and 23/5 will be moved!\\
 And since we are here, lets try to agree on best dates.\\
 Propose we move these to 13/5 and 27/5 }
