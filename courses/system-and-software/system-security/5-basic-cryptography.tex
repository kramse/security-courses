...
\item Try ssl (TLS) scanners, similar to ssh scanners
...
\item Today we only talk about encrypting the data, not how to perform attacks
\end{list1}
...
\slide{Encryption on the web -- Diffie Hellman exchange}
