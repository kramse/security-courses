...
\begin{list1}
\item {\bf Definition 18-1} The \emph{confinement problem} is the problem of preventing a server from leaking information that the user of the serrvice considers confidential.
\item
\end{list1}
...
\begin{list1}
\item {\bf Definition 18-7} The \emph{}
\item
\end{list1}
