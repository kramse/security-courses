...
Connect uplink to common switch, KramsIX. Use port 8.
...
Reset the switch to default setting - press reset for 15 seconds before doing any configuration.
...
\item Configure VLAN interface on your server with the IP in the LAN 10.0.45.0/24 - if your team ID is 14, then your IP is 10.0.45.14/24
\item Add 10.0.45.1 as your default gateway
\item Use 10.0.45.1 as DNS resolver
\item Ping 10.0.45.1 from your server
\end{enumerate}
