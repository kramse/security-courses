...
\item[\faSquareO] Lecture plan for this course will be in Fronter, as a link to Git\\
...
\item[\faSquareO] We will use virtual machines, so check BIOS settings\\
...
\item[\faSquareO] Get the supporting resources, some may be uploaded and found in Fronter and they are also linked in lecture plan
\end{list2}
