...
CryptoParty er en mulighed for inspiration til bedre sikkerhed. Vi anbefaler at du kigger på programmerne nedenfor. Du kan læse mere om Crypto Parties i The CryptoParty Handbook\\
\link{https://www.cryptoparty.in/documentation/handbook}
\hlkimage{4cm}{crypto-party-logo.png}

NB: The CryptoParty Handbook indeholder referencer til flere programmer såsom disk kryptering og VPN
...
\item Mere anonym browsing kan opnås med Tor fra \link{torproject.org} og \link{https://www.whonix.org/}
\end{itemize}
...
\item Følg vejledningerne på hjemmesiden \link{https://www.enigmail.net/documentation/quickstart.php}
