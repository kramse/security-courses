...
\slide{Form�l: Hvorfor g�r vi det her?}
...
\slide{ Ops�tning af computere og netv�rk, hvordan?}
...
\slide{Filoverf�rsel - Do NOT USE FTP}
\begin{list1}
...
\centerline{\color{titlecolor} Mere anonym browser - Firefox i forkl�dning}
...
\end{list2}
Se ogs� \link{http://www.censurfridns.dk} og \link{blog.censurfridns.dk} for mere info.
