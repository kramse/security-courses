...
\begin{list2}
\item Present one of the most versatile security tools
\item
\item
\item
\item
...
\item Is it really secure -- can we trust it, what about the default settings harden it
