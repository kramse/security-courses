...
\hlkrightpic{11cm}{-6cm}{kiwicon-2009-hackers-dont-give-shit.jpg}
...
\begin{list2}
\item SPF \link{https://en.wikipedia.org/wiki/Sender_Policy_Framework}
\item DKIM \link{https://en.wikipedia.org/wiki/DomainKeys_Identified_Mail}
\item DMARC \link{https://en.wikipedia.org/wiki/DMARC}
...
\item \emph{Network Security through Data Analysis}, 3rd Edition
By Michael S Collins
Publisher: O'Reilly Media
06-10-2017, 400 Pages
\end{list2}


\slide{Graphs and Dashboards!}

%\hlkimage{20cm}{Logstash1.png}
