...
\slide{Fokus 2019: DNS og email} og monitorering
...
\begin{list2}
\item DNS query logs, keep it for at least a week? - with DSC and PacketQ \link{https://github.com/DNS-OARC/PacketQ}
