...
\item Jeg bruger lige BackTrack
\begin{list2}
...
\slide{Diverse hackerværktøjer}

\begin{list1}
\item Vi prøver et par af hackerværktøjerne, kunne være:
\begin{list2}
\item Nikto, SSLScan, Nmap med scripts
\item W3af
\item Metasploit webudgaven
\item OpenVAS
\item Damn Vulnerable Linux - demo af en anden boot CD baseret på BackTrack
\end{list2}
\end{list1}
