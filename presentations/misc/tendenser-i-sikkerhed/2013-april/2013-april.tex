...
\hlkimage{15cm}{bind-cve-2013-2266.png}
...
\hskip 3cm            Defeating Denial of Service Attacks which employ\\
        \hskip 6cm               IP Source Address Spoofing

Note: you should try validating INCOMING traffic from customers, not trying to validate when sending ;-)
...
For mange opdateringer, jeg er træt ...
