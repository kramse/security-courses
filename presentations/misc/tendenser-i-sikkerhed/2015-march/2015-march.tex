...
\item Released Zero-day information publically about Microsoft and Apple OS X vulnerabilities
\item Patched in \emph{first Patch Tuesday of 2015, which came out on Jan. 13.}
\end{list1}
...
\slide{Moloch packet capture}

\hlkimage{15cm}{moloch-sessions.png}
