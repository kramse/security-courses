...
\mytitlepage{DDoS Testing Your Infrastructure,\\ including IPv6 SYN floods}{Hacktivity 2022}
...
\item Used to be my primary DDoS testing tool, easy to get specific rate pps
\item Now I am moving to Penguinping / MoonGen
\end{list2}
...
\centerline{Very fast and breaks most firewalls when flooding, easy 800k pps/400Mbps}
...
\link{https://github.com/kramse/hping-2018} Hping-2018, rough support for IPv6 packets\\
...
Thank you for coming. I'll be around until friday. I will try to gather this on a project web site \link{https://penguinping.org/}
