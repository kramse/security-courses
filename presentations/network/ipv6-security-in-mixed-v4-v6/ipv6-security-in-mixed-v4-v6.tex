...
\end{quote}
Source: \link{https://www.juniper.net/documentation/us/en/software/junos/security-services/topics/concept/port-security-nd-inspection.html}
...
\item \link{https://mobile.twitter.com/enno_insinuator/status/1285681172719316992} links to\\
\link{https://insinuator.net/2019/02/ipv6-security-in-an-ipv4-only-environment/}


\item \link{https://twitter.com/Enno_Insinuator/status/1224147916022898689} links to\\
\link{https://www.caida.org/catalog/papers/2016_dont_forget_lock/dont_forget_lock.pdf}
...
So grateful to be part of communities such as these!

Tried finding the most recent references, but much more can be found across their sites:
\begin{list2}
\item RIPE April 2021, new! 191 pages!\\
\link{https://www.ripe.net/support/training/material/ipv6-security/ipv6security-slides.pdf}
...
\item \link{https://datatracker.ietf.org/doc/html/rfc6092} 2011\\
\emph{Recommended Simple Security Capabilities in Customer Premises Equipment (CPE) for Providing Residential IPv6 Internet Service}
\end{list2}
