...
\vskip 3cm
{TL;DR This works mostly because you still CAN spoof packets across the internet. First time I encountered this was a big network!}
...
{\bf - and missing security tool coverage}
...
\hlkimage{19cm}{vxlan-basic-suricata-zeek.pdf}

Defensive:
\begin{list2}
\item Many firewalls/IDS/DDoS protection would not see this traffic,\\
do not consider ARP / Layer 2 / Tunnels / VXLAN
\item Tool enhancements work-in-progress, adding VXLAN decap to Zeek and Suricata
...
also my patches to Suricata and Zeek there, help me
