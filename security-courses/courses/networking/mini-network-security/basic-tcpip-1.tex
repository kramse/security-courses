...
\item Ved at tildele flere C-klasser kunne man spare de resterende B-klasser\\
- men det betød en routing table explosion
...
\begin{list1}
\item Der findes et væld af programmer som kan udregne
...
\item default er UDP pakker på Unix, og ICMP på windows 
\item på Unix systemer er der ofte mulighed for at bruge ICMP, traceroute -I
\item 
\begin{alltt}
\small{\bfseries 
...
\item AfriNIC The Registry of Internet Number Resources for Africa
\end{list2}
\item disse kaldes for Regional Internet Registries (RIRs) i
...
\vskip 2 cm
\centerline{\LARGE Husk også Jperf Java GUI program til Iperf \smiley}
