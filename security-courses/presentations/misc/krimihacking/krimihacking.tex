...
\item NB: ICANN må ikke forveksles med IANA Internet Assigned Numbers
  Authority \\
\link{http://www.iana.org/} som bestyrer portnumre m.v.
\end{list1}
...
\vskip 2cm
\centerline{ingen grund til ligefrem at udlevere mig selv på skrift :-)}
...
\begin{list1}
\item Trinity brugte et exploit program :-)
...
\hlkimage{20cm}{freescan-reklame.png}
