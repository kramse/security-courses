...
\mytitlepage{IPv6 in real networks}
...
\item Ressources, links and documents
\end{list1}
...
\begin{list1}
\item IPv6 is already there - see next slide
...
\begin{list1}
\item Use the NIST special publications
\item SP 800-119	Feb. 22, 2010	DRAFT Guidelines for the Secure Deployment of IPv6\\
Great because it both introduces IPv6 and gives security advice

\item SP 800-58	Jan 2005	Security Considerations for Voice Over IP Systems\\
Almost step by step instructions for what questions to ask your VoIP providers and how to implement VoIP securely

\item Your network needs an update to support new features, critical needs, isolation VLANs, Quality of Service, new protocols such as iSCSI, VoIP, DNSSEC - get started now
\end{list1}
...
\centerline{Remember to add IPv6 to list of requirements for new devices}

\slide{Collect information about your hosts and services}

\begin{list1}
\item servers and services, today everything is IPv4 - in Europe
\item clients - do you only support PCs running Windows? think again. Smart phones and tablets are the future
\item Desktop and laptop operating systems: regular clients such as Windows, Linux and Mac OS X HAS great IPv6 support\\(Dont ask about Windows Xp and Vista, kill them on sight)
...
\item Support for IPv6 is working on wireless and Ethernet - cellular data propbably not for a while?!
\end{list1}
...
\end{quote}
\link{http://isoc.org/wp/worldipv6day/} and \link{http://test-ipv6.com/}
