...
\usepackage[pdftitle={Security6.net education materials
},pdfauthor={Henrik Lund Kramshoej},colorlinks,
urlcolor={security6blue},menucolor={security6blue},citecolor={security6blue},
pagecolor={blue},linkcolor={security6blue}]{hyperref}   
\usepackage{makeidx}
\usepackage{calc}
%\usepackage{layout}
\usepackage{amsmath}
...
% uses to much color
%\lfoot{\hskip 0mm\colorbox{security6blue}{\makebox[170mm][l]{\color{white}
%\copyright\ copyright 2010 Security6.net, Henrik Lund Kramshøj \hfill \thepage}}}

\lfoot{\copyright\ copyright 2010 Security6.net, Henrik Lund Kramshøj \hfill \thepage}
...
% old style
%\cfoot{\small Copyright \copyright\ 2003-2007, Henrik Lund Kramshøj} 
...
%\rfoot{\thepage}
\cfoot{}
%\cfoot{\small Copyright \copyright\ 2003 Henrik Lund Kramshøj}
%\rfoot{\bfseries\thepage}
...
\def\dikudk{DIKU, Datalogisk Institut ved Københavns
...
%  \renewcommand{\chaptername}{\color{titlecolor}Øvelse}%
...
\addto\captionsenglish{%
  \renewcommand{\chaptername}{\color{titlecolor}Exercise}%
...
\title{\color{titlecolor}\LARGE \bfseries#1 \\ #2}

\author{Henrik Lund Kramshøj\\
\href{mailto:hlk@security6.net}{hlk@security6.net}} 
\date{\today}
\maketitle
